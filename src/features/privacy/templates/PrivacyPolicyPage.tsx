            ...
            <CardContent className="p-8 sm:p-12 text-justify">
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 text-center">
                    <p className="text-sm text-gray-500">
                        إذا كان لديك أي أسئلة حول سياسة الخصوصية، يرجى التواصل معنا عبر <Link to="mailto:support@alrehla.com" className="text-primary font-bold hover:underline">مركز الدعم</Link>.
                    </p>
                </div>
            </CardContent>
        </Card>
