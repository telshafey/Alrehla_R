        ...
        <div className="bg-background animate-fadeIn min-h-screen">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 bg-indigo-50/50 p-8 rounded-3xl border border-indigo-50">
                            <div className="flex-1">
                                <h3 className="text-2xl font-bold text-indigo-900 mb-4">القصة المخصصة</h3>
                                <p className="text-lg text-indigo-800/80 mb-6 leading-relaxed">
                                    قصة تُبنى حول اسم الطفل وصورته واهتماماته، ويمكن للأسرة اختيار موضوع أو قيمة من الخيارات المتاحة.
                                </p>
                                <Link to="/enha-lak/custom">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 bg-blue-50/50 p-8 rounded-3xl border border-blue-50">
                            <div className="flex-1">
                                <h3 className="text-2xl font-bold text-blue-900 mb-4">صندوق الرحلة الشهري</h3>
            ...
            <section className="py-20 bg-slate-50">
                <div className="container mx-auto px-4 max-w-6xl text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-right">
                        <TestimonialCard
                            quote="فكرة القصة المخصصة كانت هدية رائعة، ابني شعر بسعادة غامرة عندما رأى اسمه في القصة."
                            author="أم محمد"
                            role="ولية أمر"
                        />
                        <TestimonialCard
                            quote="صندوق الرحلة الشهري تجربة ممتازة وتتجدد، محتوى مفيد ويغرس قيماً مهمة بطريقة غير مباشرة."
                            author="أبو يوسف"
                            role="ولي أمر"
                        />
                    </div>
